  ...
  return (
    <div className="UserInfo">
      <div className="UserInfo__container">
        <div className="UserInfo__AvatarImage">
          <a href="/user">
            {/*  <Avatar
              width={"3rem"}
              height={"3rem"}
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="3rem" height="3rem">
              <g fillRule="evenodd">
                <defs>
                  <clipPath id="BX4U8gTTEWeVb-ytmU_mm">
                    <circle
                      cx="1.5rem"
                      cy="1.5rem"
                      r="1.5rem"
                ...
                <image
                  ...
                  clipPath="url(#BX4U8gTTEWeVb-ytmU_mm"
                ></image>
                <circle
                  cx="1.5rem"
                  cy="1.5rem"
        ...
        <div className="UserInfo__Info">
          <a href="/user">
            <p className="UserInfo__username">yomna</p>
          </a>
          <p className="UserInfo__tag">@yomna</p>
        </div>
      </div>
    </div>
  );
